...
if (!existe) {
  ...
  INSERT INTO cortos (idCorto, Nombre, FechaEstreno, IdDirector, IdActor)
   VALUES
    ...
    (4, 'Bloody Territories (Kôiki bôryoku: ryuuketsu no shima)', '2020-22-08', 4, 4),
    (5, 'Tobor the Great', '2020-26-09', 5, 2),
    (6, 'Man Escaped, A (Un  condamné à mort s''est échappé ou Le vent souffle où il veut)', '2021-21-03', 6, 9),
